...
#define GPIO_SDMMC1_D4    {GPIOB, {GPIO_PIN_8,  GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_HIGH, GPIO_AF12_SDMMC1}}
#define GPIO_SDMMC1_D5    {GPIOB, {GPIO_PIN_9,  GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_HIGH, GPIO_AF12_SDMMC1}}
#define GPIO_SDMMC1_D6    {GPIOC, {GPIO_PIN_6,  GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_HIGH, GPIO_AF12_SDMMC1}}
#define GPIO_SDMMC1_D7    {GPIOC, {GPIO_PIN_7,  GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_HIGH, GPIO_AF12_SDMMC1}}
#define GPIO_SDMMC1_CD    {GPIOG, {GPIO_PIN_0,  GPIO_MODE_INPUT, GPIO_NOPULL, GPIO_SPEED_HIGH, 0}}

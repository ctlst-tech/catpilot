...
// SDMMC bus
// SDMMC1
#define GPIO_SDMMC1_CK    {GPIOC, {GPIO_PIN_12, GPIO_MODE_AF_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF12_SDMMC1}
#define GPIO_SDMMC1_CMD   {GPIOD, {GPIO_PIN_2,  GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF12_SDMMC1}
#define GPIO_SDMMC1_D0    {GPIOC, {GPIO_PIN_8,  GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF12_SDMMC1}
#define GPIO_SDMMC1_D1    {GPIOC, {GPIO_PIN_9,  GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF12_SDMMC1}
#define GPIO_SDMMC1_D2    {GPIOC, {GPIO_PIN_10, GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF12_SDMMC1}
#define GPIO_SDMMC1_D3    {GPIOC, {GPIO_PIN_11, GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF12_SDMMC1}
#define GPIO_SDMMC1_CD    {GPIOG, {GPIO_PIN_0,  GPIO_MODE_INPUT, GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, 0}
// #define EXTI_SDMMC1_CD    {GPIO_SDMMC1_CD, {EXTI_LINE_0, EXTI_MODE_INTERRUPT, EXTI_TRIGGER_RISING, EXTI_GPIOG}, {EXTI_LINE_0, NULL}, 7, 0}

...
int USART7_Init() {
    ...
    usart7_dma_rx.DMA_InitStruct.Init.Channel = DMA_CHANNEL_5;
...
int USART8_Init() {
    ...
    usart8_dma_tx.DMA_InitStruct.Init.Channel = DMA_CHANNEL_5;
    ...
    usart8_dma_rx.DMA_InitStruct.Init.Channel = DMA_CHANNEL_5;

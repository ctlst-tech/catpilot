...
type_t ACCEL_CHIP_ID = 0xFA;

// BMI055 Accelerometer

type_t ACCEL_BGW_CHIPID    = 0x00;
...
size_t SIZE = sizeof(accel_fifo_data_t) * ACCEL_FIFO_FRAMES;
...
type_t GYRO_SIZE = sizeof(gyro_fifo_data_t) * GYRO_FIFO_FRAMES;

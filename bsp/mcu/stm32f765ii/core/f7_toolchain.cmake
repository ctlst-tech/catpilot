...
set(LINKER_FLAGS "${LINK_MAP_CREATION_FLAG} --specs=nosys.specs ${MCU_FLAGS} -Wl,--start-group -lgcc -lc -lg -Wl,--end-group -Wl,--gc-sections -u _printf_float -T ${LINKER_SCRIPT}")

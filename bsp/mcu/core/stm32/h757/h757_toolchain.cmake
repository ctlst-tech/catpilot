...
if (UNIX)
    ...
    set(LINKER_SCRIPT       ${CMAKE_CURRENT_SOURCE_DIR}/catpilot/bsp/mcu/core/stm32/h757/ld/linker_stm32h757.ld)
endif ()
...
set(CMAKE_C_FLAGS_DEBUG "-O1 -g2 ${COMMON_FLAGS}")
set(CMAKE_CXX_FLAGS_DEBUG "-O1 -g2 ${COMMON_FLAGS}")

...
// ICM20649
#define GPIO_SPI1_CS1     {GPIOC, {GPIO_PIN_2,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_HIGH, GPIO_AF0_MCO}}
#define GPIO_SPI1_DRDY1   {GPIOD, {GPIO_PIN_15, GPIO_MODE_IT_RISING, GPIO_PULLDOWN, GPIO_SPEED_FREQ_HIGH, 0}}
#define EXTI_SPI1_DRDY1   {GPIO_SPI1_DRDY1, {EXTI_LINE_15, EXTI_MODE_INTERRUPT, EXTI_TRIGGER_RISING, EXTI_GPIOD, EXTI_D3_PENDCLR_SRC_NONE}, {EXTI_LINE_15, NULL}, 6, 0}
// MS5611
...
#define GPIO_SPI2_CS1     {GPIOD, {GPIO_PIN_10,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_HIGH, GPIO_AF5_SPI2}}
...
// ACCEL MAG (?)
#define GPIO_SPI4_CS4     {GPIOC, {GPIO_PIN_15, GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_HIGH, GPIO_AF5_SPI4}}
...
// PX4IO USART6 bus
#define GPIO_USART6_TX    {GPIOC, {GPIO_PIN_6, GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_HIGH, GPIO_AF7_USART6}}
#define GPIO_USART6_RX    {GPIOC, {GPIO_PIN_7, GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_HIGH, GPIO_AF7_USART6}}

// GPS1 USART4 bus
#define GPIO_USART4_TX    {GPIOA, {GPIO_PIN_0, GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_HIGH, GPIO_AF8_UART4}}
#define GPIO_USART4_RX    {GPIOA, {GPIO_PIN_1, GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_HIGH, GPIO_AF8_UART4}}
...
// TELEM1 USART2 bus
#define GPIO_USART2_TX    {GPIOD, {GPIO_PIN_5, GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_HIGH, GPIO_AF7_USART2}}
#define GPIO_USART2_RX    {GPIOD, {GPIO_PIN_6, GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_HIGH, GPIO_AF7_USART2}}

// TELEM2 USART3 bus
#define GPIO_USART3_TX    {GPIOD, {GPIO_PIN_8, GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_HIGH, GPIO_AF7_USART3}}
#define GPIO_USART3_RX    {GPIOD, {GPIO_PIN_9, GPIO_MODE_AF_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_HIGH, GPIO_AF7_USART3}}
...
// FMU PWM
#define GPIO_FMU_PWM_1    {GPIOE, {GPIO_PIN_14,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF0_MCO}}
#define GPIO_FMU_PWM_2    {GPIOE, {GPIO_PIN_13,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF0_MCO}}
#define GPIO_FMU_PWM_3    {GPIOE, {GPIO_PIN_11,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF0_MCO}}
#define GPIO_FMU_PWM_4    {GPIOE, {GPIO_PIN_9,   GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF0_MCO}}
#define GPIO_FMU_PWM_5    {GPIOD, {GPIO_PIN_13,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF0_MCO}}
#define GPIO_FMU_PWM_6    {GPIOD, {GPIO_PIN_14,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF0_MCO}}
